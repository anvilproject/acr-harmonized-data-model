# Contributing to acr-harmonized-data-model

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
acr-harmonized-data-model. These guidelines are not strict rules.
...
The acr-harmonized-data-model team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the acr-harmonized-data-model technical leads
...
[issues]: https://github.com/anvilproject/acr-harmonized-data-model/issues/
[pulls]: https://github.com/anvilproject/acr-harmonized-data-model/pulls/
