...
# Slot: Sample Availability (availability_status) 
...
URI: [acr_harmonized_data_model:availability_status](https://w3id.org/anvilproject/acr-harmonized-data-model/availability_status)
...
| ---  | ---  |
| self | acr_harmonized_data_model:availability_status |
| native | acr_harmonized_data_model:availability_status |
