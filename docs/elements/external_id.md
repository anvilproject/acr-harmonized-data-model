...
# Slot: External Identifiers (external_id) 


_Other identifiers for this entity, eg, from the submitting study or in systems like dbGaP_
...
URI: [acr_harmonized_data_model:external_id](https://w3id.org/anvilproject/acr-harmonized-data-model/external_id)
...
| ---  | ---  |
| self | acr_harmonized_data_model:external_id |
| native | acr_harmonized_data_model:external_id |
...
```yaml
name: external_id
description: Other identifiers for this entity, eg, from the submitting study or in
  systems like dbGaP
