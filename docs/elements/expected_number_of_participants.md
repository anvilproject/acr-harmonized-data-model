...
_Total expected number of participants to be recruited._
...
URI: [acr_harmonized_data_model:expected_number_of_participants](https://w3id.org/anvilproject/acr-harmonized-data-model/expected_number_of_participants)
...
| ---  | ---  |
| self | acr_harmonized_data_model:expected_number_of_participants |
| native | acr_harmonized_data_model:expected_number_of_participants |
