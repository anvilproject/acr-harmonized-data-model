...
# Slot: Access Policy ID (access_policy_id) 
...
URI: [acr_harmonized_data_model:access_policy_id](https://w3id.org/anvilproject/acr-harmonized-data-model/access_policy_id)
...
| [AccessPolicy](AccessPolicy.md) | The access policy that describes the controls around use of data |  yes  |
...
| Domain Of | [Record](Record.md), [AccessPolicy](AccessPolicy.md) |
...
| ---  | ---  |
| self | acr_harmonized_data_model:access_policy_id |
| native | acr_harmonized_data_model:access_policy_id |
